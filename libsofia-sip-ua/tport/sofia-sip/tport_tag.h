...
#define TPTAG_TLS_CERTIFICATE_FILE(x) tptag_tls_certificate_file, tag_str_v((x))
...
#define TPTAG_TLS_CERTIFICATE_CHAIN_FILE(x) tptag_tls_certificate_chain_file, tag_str_v((x))
