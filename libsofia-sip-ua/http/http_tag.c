...
tag_typedef_t httptag_sec_websocket_key = HTTPHDRTAG_TYPEDEF(sec_websocket_key);
tag_typedef_t httptag_sec_websocket_key_str = HTTPSTRTAG_TYPEDEF(sec_websocket_key);


tag_typedef_t httptag_origin = HTTPHDRTAG_TYPEDEF(origin);
tag_typedef_t httptag_origin_str = HTTPSTRTAG_TYPEDEF(origin);


tag_typedef_t httptag_sec_websocket_protocol = HTTPHDRTAG_TYPEDEF(sec_websocket_protocol);
tag_typedef_t httptag_sec_websocket_protocol_str = HTTPSTRTAG_TYPEDEF(sec_websocket_protocol);


tag_typedef_t httptag_sec_websocket_version = HTTPHDRTAG_TYPEDEF(sec_websocket_version);
tag_typedef_t httptag_sec_websocket_version_str = HTTPSTRTAG_TYPEDEF(sec_websocket_version);
