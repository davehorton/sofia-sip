...
# if defined (HTTP_HCLASS)
  ...
  56,
  {
    ...
    { http_sec_websocket_key_class, msg_offsetof(http_t, http_sec_websocket_key) },
    ...
    { http_sec_websocket_version_class, msg_offsetof(http_t, http_sec_websocket_version) },
    { NULL, 0 },
    ...
    { NULL, 0 },
    { http_origin_class, msg_offsetof(http_t, http_origin) },
    { http_vary_class, msg_offsetof(http_t, http_vary) },
    { http_sec_websocket_protocol_class, msg_offsetof(http_t, http_sec_websocket_protocol) },
