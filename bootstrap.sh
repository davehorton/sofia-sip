...
check_lt_ver() {
  ...
  libtool=${LIBTOOL:-`${BASEDIR}/PrintPath glibtool libtool libtool22 libtool15 libtool14`}
  libtool=${LIBTOOL:-`${BASEDIR}/PrintPath glibtool libtool libtool22 libtool15 libtool14`}
...
check_libtoolize() {
  ...
  if [ -n "${LIBTOOL}" ]; then
    ...
    libtoolize=${LIBTOOLIZE:-`${BASEDIR}/PrintPath glibtoolize libtoolize libtoolize22 libtoolize15 libtoolize14`}
  fi
